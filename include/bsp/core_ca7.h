...
typedef struct
{
  ...
  __IOM uint32_t D_CTLR;                 /*!< Offset: 0x000 (R/W) Distributor Control Register */
  __IM  uint32_t D_TYPER;                /*!< Offset: 0x004 (R/ )  Interrupt Controller Type Register */
  __IM  uint32_t D_IIDR;                 /*!< Offset: 0x008 (R/ )  Distributor Implementer Identification Register */
        uint32_t RESERVED1[29];
  __IOM uint32_t D_IGROUPR[32];          /*!< Offset: 0x080 - 0x0FC (R/W) Interrupt Group Registers */
  __IOM uint32_t D_ISENABLER[32];        /*!< Offset: 0x100 - 0x17C (R/W) Interrupt Set-Enable Registers */
  __IOM uint32_t D_ICENABLER[32];        /*!< Offset: 0x180 - 0x1FC (R/W) Interrupt Clear-Enable Registers */
  __IOM uint32_t D_ISPENDR[32];          /*!< Offset: 0x200 - 0x27C (R/W) Interrupt Set-Pending Registers */
  __IOM uint32_t D_ICPENDR[32];          /*!< Offset: 0x280 - 0x2FC (R/W) Interrupt Clear-Pending Registers */
  __IOM uint32_t D_ISACTIVER[32];        /*!< Offset: 0x300 - 0x37C (R/W) Interrupt Set-Active Registers */
  __IOM uint32_t D_ICACTIVER[32];        /*!< Offset: 0x380 - 0x3FC (R/W) Interrupt Clear-Active Registers */
  __IOM uint8_t  D_IPRIORITYR[255];      /*!< Offset: 0x400 - 0x7F8 (R/W) Interrupt Priority Registers */
        uint32_t RESERVED2;
  __IOM uint8_t  D_ITARGETSR[255];       /*!< Offset: 0x800 - 0xBF8 (R/W) Interrupt Targets Registers */
        uint32_t RESERVED3;
  __IOM uint32_t D_ICFGR[64];            /*!< Offset: 0xC00 - 0xCFC (R/W) Interrupt Configuration Registers */
        uint32_t RESERVED4[64];
  __IOM uint32_t D_NSACR[64];            /*!< Offset: 0xE00 - 0xEFC (R/W) Non-secure Access Control Registers */
  __OM  uint32_t D_SGIR;                 /*!< Offset: 0xF00 ( /W) Software Generated Interrupt Register */
  ...
  __IOM uint32_t C_BPR;                  /*!< Offset: 0x10008 (R/W) Binary Point Register */
  __IM  uint32_t C_IAR;                  /*!< Offset: 0x1000C (R/ ) Interrupt Acknowledge Register */
  __OM  uint32_t C_EOIR;                 /*!< Offset: 0x10010 ( /W) End Of Interrupt Register */
  __IM  uint32_t C_RPR;                  /*!< Offset: 0x10014 (R/ ) Running Priority Register */
  __IM  uint32_t C_HPPIR;                /*!< Offset: 0x10018 (R/ ) Highest Priority Pending Interrupt Register */
  __IOM uint32_t C_ABPR;                 /*!< Offset: 0x1001C (R/W) Aliased Binary Point Register */
  __IM  uint32_t C_AIAR;                 /*!< Offset: 0x10020 (R/ ) Aliased Interrupt Acknowledge Register */
  __OM  uint32_t C_AEOIR;                /*!< Offset: 0x10024 ( /W) Aliased End Of Interrupt Register */
  __IM  uint32_t C_AHPPIR;               /*!< Offset: 0x10028 (R/ ) Aliased Highest Priority Pending Interrupt Register */
        uint32_t RESERVED8[41];
  __IOM uint32_t C_APR[4];               /*!< Offset: 0x100D0 - 0x10DC (R/W) Active Priority Register */
  __IOM uint32_t C_NSAPR;                /*!< Offset: 0x100E0 (R/W) Non-secure Active Priority Register */
        uint32_t RESERVED9[6];
  __IM  uint32_t C_IIDR;                 /*!< Offset: 0x100FC (R/ ) CPU Interface Identification Register */
        uint32_t RESERVED10[960];
  __OM  uint32_t C_DIR;                  /*!< Offset: 0x12000 ( /W) Deactivate Interrupt Register */
} GIC_Type;
